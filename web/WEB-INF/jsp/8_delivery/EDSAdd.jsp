...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <head>
            <title>IMS - New Export Delivery Slip (EDS)</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                    <form action="Eds.htm" method="post" id="tsAddForm">
                        <input type="hidden" name="action" value="save" />

                        <table class="collapse tblForm row-select">
                            <caption>Export Delivery Slip - EDS</caption>
                            <tbody class="tbl-nohover">                               
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="buyer" id="buyer" size="30" value="" />
                                        </label>
                                    </td>
                                    <td>EDS Date</td>
                                    <td class="style1">
                                        <label>
                                            <input type="text" id="tsdate" name="tsdate" value="<%= new SimpleDateFormat("dd/MM/yyyy").format(new Date()) %>" readonly size="30"/>
                                        </label>
                                    </td>
                               </tr>
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" id="noCI" name="noCI" value="" size="30"/>
                                        </label>
                                    </td>
                               </tr>
                               <tr class="detail_genap">
                                    <td>&nbsp;</td>
                                    <td width="20%">Pack Style</td>
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="packStyle" id="packStyle" size="30" value="" />
                                        </label>
                                    </td>
                                    <td>Brand</td>
                                    <td class="style1">
                                        <label>
                                            <input type="text" id="brand" name="brand" value="" size="30"/>
                                        </label>
                                    </td>
                               </tr>
                              ...
                              <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="reference" name="reference" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td>Destination</td>
                                    <td class="style1">
                                    	<label>
	                                        <input type="text" id="destination" name="destination" value="" size="30" />
                                    	</label>
                                    </td>
                               </tr>
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="van" name="van" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td>Ship Seal</td>
                                    <td class="style1">
                                    	<label>
	                                        <input type="text" id="shipSeal" name="shipSeal" value="" size="30" />
                                    	</label>
                                    </td>
                               </tr>
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="vessel" name="vessel" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td>Plat No</td>
                                    <td class="style1">
                                    	<label>
	                                        <input type="text" id="platNo" name="platNo" value="" size="30" />
                                    	</label>
                                    </td>
                               </tr>
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="timeIn" name="timeIn" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td>Time Out</td>
                                    <td class="style1">
                                    	<label>
	                                        <input type="text" id="timeOut" name="timeOut" value="" size="30" />
                                    	</label>
                                    </td>
                               </tr>
                               ...
                               <tr class="detail_genap">
                                    <td>&nbsp;</td>
                                    <td width="20%">Name of Driver</td>
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="driverName" name="driverName" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td></td>
                                    <td class="style1">
                               ...
                               <tr class="detail_genap">
                                    <td>&nbsp;</td>
                                    <td width="20%">Can SIze</td>
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="canSize" name="canSize" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td>Number of Cases</td>
                                    <td class="style1">
                                    	<label>
	                                        <input type="text" id="noCases" name="noCases" value="" size="30" />
                                    	</label>
                                    </td>
                               </tr>    
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
	                                        <input type="text" id="unitPrice" name="unitPrice" value="" size="30" />
                                    	</label>
                                    </td>
                                    <td>Amount</td>
                                    <td class="style1">
