...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <head>
            <title>IMS - New Book Order Report</title>
            <%@include file="../metaheader.jsp" %>
            <script language="JavaScript">
                $(document).ready(function(){
                    
                    $('#borAddForm').validationEngine('attach');        
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                    <form action="Bor.htm" method="post" id="borAddForm">
                        <input type="hidden" name="mode" value="<%=mode%>" />
                        <input type="hidden" name="action" value="save" />

                        <table class="collapse tblForm row-select">
                            <caption>Book Order Report Add</caption>
                            <tbody class="tbl-nohover">

                                <tr class="detail_genap">
                                    <td>&nbsp;</td>
                                    <td width="20%">BOR No</td>
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="bornumber" id="bornumber" value="" size="30"                                                    
                                  ...
                                  <td>&nbsp;</td>
                                    ...
                                    <td class="style1">
                                        <label>                                                                                                                                                                             
                                            <input type="text" name="bordate" size="25" id="bordate" readonly 
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="buyername" id="buyername" value="" size="30"                                                    
                                                   class="validate[required] text-input" />
                                        </label>
                                    </td>
                                    <td></td>
                                ...
                                <tr><td colspan="7">
                                        <label>
                                            <input type="button" style="font-size: smaller;" aria-disabled="false"                                                    
                                                   ...
                                                   name="btnSaveBor" id="btnSaveBor" value="Save" class="simpan" />
                                        </label>
                                        <label>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#btnSaveBor").click(function () {                         

                    //if invalid do nothing
                    if(!$("#borAddForm").validationEngine('validate')){
