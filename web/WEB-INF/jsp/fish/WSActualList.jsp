                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <input type="button" value="Add" name="btnAdd" onclick="window.location.replace('FishWsActual.htm?action=create');" />
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                            ...
                            <tr>
                                <td colspan="6">
                                    <c:if test="${model.page !=null && model.page > 1}">
                                        <a href="FishWsActual.htm?page=<c:out value="${model.page-1}" />">&lt</a>
                                    </c:if>
                                    &nbsp;page: ${model.page}&nbsp;
                                    <c:if test="${model.page < model.totalRows/model.paging}">
                                        <a href="FishWsActual.htm?page=<c:out value="${model.page+1}" />">&gt;</a>
                                    </c:if>
                                </td>
                            </tr>
                        </tfoot>
