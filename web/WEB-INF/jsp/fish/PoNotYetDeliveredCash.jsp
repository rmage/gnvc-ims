...
<html>
    <head>
        <title>IMS - Generate Po Not Yet Delivered Cash</title>
    ...
    <body>
                ...
                <div class="box">
                    <form action="#" method="post" id="genForm">
                        <table class="collapse tblForm row-select">
                            <caption>Generate Po Not Yet Delivered Cash</caption>
        ...
        <script>
            $('#genForm').bind('submit', function() {
                window.location.replace('GenerateReport.htm?action=index&item=PPoNotyetDeliveredCash&type=' + $('#type').val() + '&params=' + $('#canvasser').val());
                return false;
            });
        </script>
    </body>
