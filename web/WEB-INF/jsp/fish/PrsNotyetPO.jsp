...
<html>
    <head>
        <title>IMS - Generate PRS Not Yet PO</title>
    ...
    <body>
                ...
                <div class="box">
                    <form action="#" method="post" id="genForm">
                        <table class="collapse tblForm row-select">
                            <caption>Generate PRS Not Yet PO</caption>
        ...
        <script>
            $('#genForm').bind('submit', function() {
                window.location.replace('GenerateReport.htm?action=index&item=PPrsNotyetPO&type=' + $('#type').val() + '&params=' + $('#canvasser').val());
                return false;
            });
        </script>
    </body>
