                        ...
                        $('.check').live("click", function() {
                        	...
                        	$.ajax({
                                ...
                                success: function(data) {
                                     $.each(data.putawayDetail, function(k,v){
                                        ...
                                        $("<tr class=\"myhover\">"+                                            
                                               ...
                                               // "<td class=\"style1\">"+v.lotId+"</td>"+
                                                ...
                                                "<input type=\"hidden\" name=\"balance\" id=\"balance"+rowCount+"\" value=\""+v.qty+"\">"+
                                    ...
                                    url: 'locationproductpicking.htm?productId='+$(this).attr('productcode')                            
                                  });
                            ...
                            $("#dialog").dialog({ width: 800, height: 400, position: "center", modal: true, 
                                buttons: {
                                    "Cancel": function() {            
                                    	...
                                    	/*
                                    	if(requestQty < valueInput) {
                                            alert('value must be same with request qty');
                                            return false;
                                        }
                                    	else if(requestQty > valueInput) {
                                            alert('value must be same with request qty');
                                            return false;
                                        }
                                    ...
                                    "Save": function() {
                                    	...
                                    	for(var i = 2; i <= jumlahRow ; i++){
                                    		...
                                    		balanceBr  = balanceBr + $('#balance'+i).val()+"<br />";
                                    		locationBr = locationBr + $('#location'+i).val()+"<br />";
                                    		console.log("balance loop="+balanceBr);
                                    		console.log("location code="+locationBr);
                                    	...
                                    	$('#'+productCode+"-balance").html(balanceBr);
                                    	...
                                    	$('#'+productCode+"-balance1").val(balanceBr);
                                   ...
                                   $("#main tbody").html('');
                                       ...
                                       $("<tr class=\"myhover\">"+
		                                   ...
		                                   // "<input type=\"hidden\" name=\"balance\" value=\""+v.balance+"\">"+
		                                    "<input type=\"hidden\" name=\"balance\" id=\""+v.productCode+"-balance1\" /> "+
		                                    ...
		                                    "<td class=\"style1\"><span id=\""+v.productCode+"-balance\"></span>"+"</td>"+
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                    <form action="PickingAdm.htm" method="post" id="pickingAddForm">
                            ...
                            <tbody class="tbl-nohover">
                               ...
                               <tr class="detail_genap">
                                    ...
                                    <td width="30%" class="style1">
                                        <label>
                                            <input type="text" name="pickingNo" value="<%=m.get("pickingNo")%>" size="30" readonly/>
                                        </label>
                                    </td>
                               ...
                               <tr class="detail_ganjil">
                                  ...
                                  <td class="style1">
                                      <label>
                                          <input type="text" name="pickingDate" value="<%=m.get("date")%>" size="30" readonly/>
                                      </label>
                                  </td>
                               ...
                               <tr>
                                    ...
                                    <td class="style1">
                                            ...
                                            <input type="text" name="so_number" id="so_number" value="" size="30" /> 
                                	...
                                	<td>Tally Man</td>
                                     <td class="style1">
                                        <label>
                                            <input type="text" name="tallyman" id="tallyman" value="" size="30" />
                                            <img width="16" height="16" src="resources/images/search.png" alt="Search TallyMan" />
                                        </label>   
                                         <label class="requiredfield" title="This Field Is Required!">*</label>                                     
                                    </td>
                               </tr>
							...
							<caption>Location Detail - List</caption>
	                            ...
	                            <tfoot><br/>
	                                <tr>
	                                    <td colspan="4">
		                                    <label>
                                        		<input type="button" style="font-size: smaller;" aria-disabled="false" role="button" class="ui-button ui-widget ui-state-default ui-corner-all" name="btnSavePicking" id="btnSavePicking" value="Save" />
                                   			</label>
		                                    <label>
        ...
        <script type="text/javascript">
            $(function() {
                $('#btnCancel').click(function() {
                    location.href = 'PickingAdm.htm?action=findAll';
                });
             ...
             <form>
                 <table>
                     ...
                     <tr>
                         ...
                         <td><input type="text" name="productname" id="productname" value="" readonly size="50"/></td>
                          <td>&nbsp;</td>
                         <td>&nbsp;</td>
                         <td>&nbsp;</td>
                         <td>&nbsp;</td>
                  ...
                  <table class="collapse tblForm row-select" id="locationPicking">
                    ...
                    <thead>
                            <tr>
                                ...
                                <td> <label for="name">Pick Value</label></td>                         
                            </tr>
                    </thead>
                    <tbody>
                 </tbody>
