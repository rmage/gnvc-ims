    ...
    <body>
        <div class="container">
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                    <form action="Delivery.htm" id="search" method="post">
                        <table class="collapse tblForm row-select">
                            <caption>Return Cargo - Filter Form</caption>
                            <tbody>
                                <tr>
                                    <td style="width: 200px;">RR Number</td>
                                    <td><input type="text" name="rrCode" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <input type="button" value="Add" name="btnAdd" onclick="window.location.replace('ReturnCargoDr.htm?action=create');" />
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <table id="list" class="collapse tblForm row-select">
                        <caption>Return Cargo - Data List</caption>
                        <thead>
                            <tr>
