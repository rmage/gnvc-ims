...
<html>
    <head>
        <title>Create Purchase Requisition Slip - IMS</title>
                ...
                $("#dialog-confirm").dialog({width: 300, height: 150, position: "center", modal: true,
                    buttons: {
                        ...
                        "Save": function() {
                            ...
                            var data = '';
                            var header = gnvs.util.toDBDate($('#prsdate').val()) + ':s:' + gnvs.util.toDBDate($('#requestdate').val()) + ':s:' + $('#remarks').val() + ':s:' + $('#departmentName').val() + ':s:';
                            $('#main tbody tr').each(function() {
                                var detail = '';
                                $(this).find('input').each(function() {
                                    detail = detail + $(this).val() + ':s:';
                                });
