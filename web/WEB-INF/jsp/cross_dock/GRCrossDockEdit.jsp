                        ...
                        <table class="collapse tblForm row-select ui-widget-content">
                            ...
                            <tbody class="tbl-nohover">
                                ...
                                <tr style="background: none repeat scroll 0% 0% rgb(250, 250, 250);">
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" class="validate[required]" size="30" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${model.list.GRDate}" />" id="grDate" name="grDate" />
                                        </label>
                                    ...
                                    <tr class="detail-item" code="${listGR.GRCodeDtl}" status="${listGR.GRStatus}" data="C">
                                        ...
                                        <td>
                                            <c:if test="${listGR.GRStatus == 'Y'}">
                                                <input type="checkbox" class="list-status" checked />
                                            </c:if>
                                            <c:if test="${listGR.GRStatus == 'N'}">
                                                <input type="checkbox" class="list-status" />
                                            </c:if>
                                        </td>  
                                    </tr>
                                </c:forEach>
                ...
                $(function(){
                    ...
                    $('#btnSave').mousedown(function(){
                        ...
                        $('#list tr').each(function(){
                            var data = $(this).attr('code') + "," + $(this).attr('status') + "," + $(this).attr('data');
