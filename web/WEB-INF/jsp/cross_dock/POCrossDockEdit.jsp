...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>IMS - Purchase Order Cross Dock Update</title>
    ...
    <body>
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                    <form id="formPO" method="post" action="POCrossDock.htm" autocomplete="off">
                        ...
                        <input type="hidden" name="poCode" value="${model.list.POCode}" />
                        <input type="hidden" name="poNumber" value="${model.list.PONumber}" />
                        ...
                        <table class="collapse tblForm row-select ui-widget-content">
                            ...
                            <tbody class="tbl-nohover">
                                ...
                                <tr style="background: none repeat scroll 0% 0% rgb(250, 250, 250);">
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" class="validate[required]" size="30" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${model.list.PODate}" />" id="poDate" name="poDate" />
                                        </label>
                                        <label title="This Field Is Required!" class="requiredfield">*</label></td>
                                </tr>
                            </tbody>
                        ...
                        <table id="infoPutaway" class="collapse tblForm row-select ui-widget-content">
                            ...
                            <tbody class="tbl-nohover">
                                <tr>
                                    <td>Putaway No</td>
                                    <td><input type="text" id="putawayCode" size="30" readonly /></td>
                                </tr>
                                <tr>
                                    <td>Putaway Date</td>
                        ...
                        <table class="collapse tblForm row-select ui-widget-content">
                            ...
                            <tbody id="list" class="tbl-nohover">
                                <c:forEach items="${model.listDetail}" var="list" varStatus="status">
                                    <tr class="detail-item" data="${list.productCode},${model.listProduct[status.index].productName},${list.POQty},${list.POType},C">
        ...
        <script type="text/javascript">
                    ...
                    $.ajax({
                        ...
                        success: function(html){
                            ...
                            if(html != 'N'){
                                ...
                                var data = split[0] + "," + split[1] + "," + $('#addQty').val() + "," + $('#addType').val() + ",N";
            ...
            function btnEdit(){
                ...
                var data = $('#addCode').val() + "," + split[1] + "," + $('#addQty').val() + "," + $('#addType').val() + ",U";
                tr.attr('data', data);
