<%-- 
    Document   : rptPymntRecivSumForFinc
    Created on : Mar 16, 2012, 2:50:46 PM
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Payment Receive Summary For Finance</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptPymntRecivSumForFinc Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Payment Receive Summary Method</caption>
                        <form:form method="post" action="rptPymntRecivSumForFinc.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptPymntRecivSumForFin" />
