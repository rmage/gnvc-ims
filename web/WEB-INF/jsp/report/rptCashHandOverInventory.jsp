...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptCashHandOverInventory Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Cash HandOver Inventory</caption>
                        <form:form method="post" action="rptCashHandOverInventory.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptCashHandOverInventory" />
                            <input type="hidden" name="parametersKey" value="P_DEALER_CODE"/>
