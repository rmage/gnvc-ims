<%--
    Document   : rptDsaActivationStatusDetail
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Dsa Activation Status Detail</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptDsaActivationStatusDetail Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Dsa Activation Status Detail</caption>
                        <form:form method="post" action="rptDsaActivationStatusDetail.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptDsaActivationStatusDetail" />
