<%-- 
    Document   : rptStockReturnSerialized
    Created on : Dec 7, 2011, 11:10:52 AM
    Author     : yasir
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Stock Return Serialized Report</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptStockReturnSerialized Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Stock Serialized Return</caption>
                        <form:form method="post" action="rptStockReturnSerialized.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptStockReturnSerialized" />
                            <input type="hidden" name="parametersKey" value="P_DEALER_CODE,P_START_DATE,P_END_DATE,P_ITEM_TYPE,P_USERNAME"/>
...
<%--                             <tr>
                                <td class="style1">Item Category</td>
                                <td class="style1">
                                    <label>
                                        <form:select path="itemType">
                                            <form:option value="%%" label="All Type"/>
                                            <c:forEach items="${model.catalogs}" var="catalog" varStatus="prodCounter">
                                                <form:option value="${catalog.name}" label="${catalog.name}"/>
                                            </c:forEach>
                                        </form:select>
                                    </label>
                                </td>
