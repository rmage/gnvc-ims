<%-- 
    Document   : rptPymntRecivSum
    Created on : Dec 8, 2011, 2:44:31 PM
    Author     : yasir
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Payment Receive Summary</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptPymntRcvDtl Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Payment Receive Summary Method</caption>
                        <form:form method="post" action="rptPymntRecivSum.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptPymntRecivSum" />
