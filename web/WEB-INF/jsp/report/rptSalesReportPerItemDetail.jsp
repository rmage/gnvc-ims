<%--
    Document   : rptSalesReportPerItemDetail
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Sales Report Per Item Detail</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptSalesReportPerItemDetail Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Sales Report Per Item Detail</caption>
                        <form:form method="post" action="rptSalesReportPerItemDetail.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptSalesReportPerItemDetail_v2_1_" />
