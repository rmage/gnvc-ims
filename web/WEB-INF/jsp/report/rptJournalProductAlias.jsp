<%-- 
    Document   : rptJournalProductAlias
    Created on : Mar 2, 2012, 11:46:35 AM
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Journal Product Alias</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptJournalProductAlias Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Journal Product Alias</caption>
                        <form:form method="post" action="rptJournalProductAlias.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptJournalProductAlias" />
