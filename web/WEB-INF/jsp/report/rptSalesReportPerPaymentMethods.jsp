<%--
    Document   : rptSalesReportPerPaymentMethods
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Sales Report Per Payment Methods</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptSalesReportPerPaymentMethods Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Sales Report Per Payment Methods</caption>
                        <form:form method="post" action="rptSalesReportPerPaymentMethods.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptSalesReportPerPaymentMethods_xls" />
