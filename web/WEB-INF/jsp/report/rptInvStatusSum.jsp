...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Inventory Status Sum</title>
    ...
    <body>
        <div class="container">
            ...
            <h1><h:outputText value="rptInvStatusSum Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Inventory Status Sum</caption>
                        <form:form method="post" action="rptInvStatusSum.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptInvStatusSum_v2" />
                            <input type="hidden" name="parametersKey" value="P_LOCATION,P_DEALER_CODE,P_USERNAME,P_ITEM_TYPE"/>
