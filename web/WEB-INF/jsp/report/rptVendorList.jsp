<%-- 
    Document   : rptVendorList
    Created on : Sep 23, 2010, 11:51:03 AM
    Author     : ruli
--%>
...
<html>
    <head>
        <title>Report Vendor List</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptVendorList Form"/></h1>

            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Vendor List</caption>
                        <form:form method="post" action="rptVendorList.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                                <input type="hidden" name="templateName" value="rptVendorList" />
