<%-- 
    Document   : rptJournalBundle
    Created on : Mar 2, 2012, 11:27:05 AM
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptJournalBundle Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Journal Bundle</caption>
                        <form:form method="post" action="rptJournalBundle.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptJournalBundle" />
