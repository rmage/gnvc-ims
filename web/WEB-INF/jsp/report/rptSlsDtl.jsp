<%-- 
    Document   : rptSlsDtl
    Created on : Dec 8, 2011, 12:11:43 PM
    Author     : yasir
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptSlsDtl Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Sales Detail</caption>
                        <form:form method="post" action="rptSlsDtl.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptSlsDtl" />
