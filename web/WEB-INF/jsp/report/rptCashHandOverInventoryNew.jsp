<%-- 
    Document   : rptCashHandOverInventoryNew
    Created on : Dec 23, 2011, 5:12:44 PM
    Author     : yasir
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Cash Hand Over Inventory New</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptCashHandOverInventoryNew Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Cash Hand Over Inventory New</caption>
                        <form:form method="post" action="rptCashHandOverInventoryNew.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptCashHandOverInventoryNew" />
                            <input type="hidden" name="parametersKey" value="P_DEALER_CODE,P_USERNAME"/>
