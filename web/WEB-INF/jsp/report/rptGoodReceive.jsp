<%-- 
    Document   : rptGoodReceive
    Created on : Dec 6, 2011, 2:18:44 PM
    Author     : yasir
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptGoodReceive Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Good Receive</caption>
                        <form:form method="post" action="rptGoodReceive.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptGoodReceive" />
