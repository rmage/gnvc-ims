<%--
    Document   : rptpostPaidPaymentRecord
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report postpaid Payment</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptpostPaidPaymentReport Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report postpaid Payment Report</caption>
                        <form:form method="post" action="rptpostPaidPaymentReport.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptpostPaidPaymentReport_v2" />
