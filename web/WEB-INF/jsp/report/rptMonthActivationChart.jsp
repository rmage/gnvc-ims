<%--
    Document   : rptMonthActivationChart
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Month Activation Chart Report</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptMonthActivationChart Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Month Activation Chart Report</caption>
                        <form:form method="post" action="rptMonthActivationChart.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptMonthActivationChart" />
                            <input type="hidden" name="parametersKey" value="P_LOCATION,P_MONTH,P_USERNAME"/>
                            ...
                            <tr>
                                ...
                                <td class="style1">
                                    <form:select path="year">
                                        <c:forEach items="${model.years}" var="year" varStatus="prodCounter">
