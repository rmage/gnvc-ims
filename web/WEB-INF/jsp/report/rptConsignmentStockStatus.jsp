<%-- 
    Document   : rptConsignmentStockStatus
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Consignment Stock Status Report</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptStockStsConsignment Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Consignment Stock Status</caption>
                        <form:form method="post" action="rptConsignmentStockStatus.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptStockStsConsignment" />
