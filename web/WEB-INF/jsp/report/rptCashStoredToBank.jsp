...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Cash Stored to Bank</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptCashStoredToBank Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Cash Stored to Bank</caption>
                        <form:form method="post" action="rptCashStoredToBank.htm" commandName="dto" id="repform">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptCashStoredToBank" />
                            <input type="hidden" name="parametersKey" value="P_LOCATION,P_DEALER_CODE,P_START_DATE,P_END_DATE,P_USERNAME"/>
                            ...
                            <tr><td class="style1">
                                    <label for="start_date_label">Start Date</label></td>
                                <td class="style1">
                                    <input id="start-date" class="date-pick" type="text" name="startDate" value="${fstartdate}" />
                                </td>
                            </tr>
