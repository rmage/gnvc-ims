<%--
    Document   : rptPettyCashManagement
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Petty Cash Management</title>
    ...
    <body>
        <div class="container">
            ...
            <h1><h:outputText value="rptPettyCashManagement Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Petty Cash Management</caption>
                        <form:form method="post" action="rptPettyCashManagement.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptPettyCashManagement" />
                            <input type="hidden" name="parametersKey" value="P_LOCATION,P_DEALER_CODE,P_USERNAME"/>
