<%-- 
    Document   : rptPymntRcvDtl
    Created on : Dec 8, 2011, 1:25:57 PM
    Author     : yasir
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Payment Receive detail</title>
            ...
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">
                    ...
                    <table class="collapse tblForm row-select">
                        <caption>Generate Payment Receive Detail Method</caption>
                        <form:form method="post" action="rptPymntRcvDtl.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptPymntRcvDtl" />
