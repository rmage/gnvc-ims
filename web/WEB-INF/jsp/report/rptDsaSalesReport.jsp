...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Report Dsa Sales Report</title>
    ...
    <body>
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptDsaSalesReport Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Dsa Sales Report</caption>
                        <form:form method="post" action="rptDsaSalesReport.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptDsaSalesReport" />
                            ...
                            <%-- mencurigakan, kenapa pada di comment in ya. tri 2010-11-21 --%>
                            <!--
                            <tr>
