<%-- 
    Document   : rptStockMovingReturn
    Created on : May 14, 2012, 12:23:52 PM
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Stock Moving And Return Report</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            %>
            <h1><h:outputText value="rptStockMovingReturn Form"/></h1>
            <div id="content" style="display: none" class="span-19 last">
                <div class="box">

                    <table class="collapse tblForm row-select">
                        <caption>Generate Report Stock Moving And Return</caption>
                        <form:form method="post" action="rptStockMovingReturn.htm" commandName="dto">
                            <tbody class="tbl-nohover">
                            <input type="hidden" name="templateName" value="rptStockMovingReturn" />
