...
<head>
        <title>IMS - Pick List Product Kitting</title>
...
<body>
	...
	<table class="collapse tblForm row-select">
		<caption>Product Picking - List</caption>
				...
				<c:forEach var="prod" items="${requestScope.model.tableMap}" varStatus="prodCounter">
				    ...
				    <tr class="ganjil">
						...
						<td class="style1" class="mid">
						    <form method="post" action="Kitting.htm">
								<input type="hidden" name="action" value="addSelectedProduct"/>
								<input type="hidden" name="productId" value="<c:out value="${prod.value.productId}"/>"/>
			...
			<tfoot>
			    <td colspan="5">
					<form method="get" action="Kitting.htm">
