...
<html>
    <head>
        <title>IMS - Generate RR Registered per Periode</title>
    ...
    <body>
                ...
                <div class="box">
                    <form action="#" method="post" id="genForm">
                        <table class="collapse tblForm row-select">
                            <caption>Generate RR Registered per Periode</caption>
        ...
        <script>
            ...
            $('#genForm').bind('submit', function() {
                ...
                window.location.replace('GenerateReport.htm?action=index&item=RRPeriode&type=' + $('#type').val() + '&params=' + 
