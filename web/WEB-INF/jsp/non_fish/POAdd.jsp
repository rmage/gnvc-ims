...
<html>
    <head>
        ...
        <title>Create Purchase Order - IMS</title>
    ...
    <body>
        ...
        <script>
            ...
            $('#save').bind('click', function() {
                ...
                $('#main tr.bold').each(function() {
                    data = data + header + $(this).find('td:eq(1)').html() + ':s:' + $(this).find('td:eq(2)').html() + ':s:' + $(this).find('td:eq(4)').html() + ':s:' + $(this).find('td:eq(8)').html().replace(/,/g, '') + ':s::se:';
                });
