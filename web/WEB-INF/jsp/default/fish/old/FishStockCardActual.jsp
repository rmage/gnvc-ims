...
<html>
    <head>
        ...
        <title>IMS &therefore; Fish Stock Card &therefore; Actual</title>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="search" method="post">
                        ...
                        <input type="hidden" name="item" value="FishStockCardActual" />
                        <input type="hidden" name="type" value="xls" />
                        <input type="hidden" id="params" name="params" value="<%=cDateH %>" />
                        <table class="collapse tblForm row-select">
                            <caption>Stock Card &therefore; Fish &therefore; Actual</caption>
                            <tbody>
                                <tr>
