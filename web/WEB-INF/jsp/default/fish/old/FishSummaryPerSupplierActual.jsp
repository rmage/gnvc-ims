...
<html>
    <head>
        ...
        <title>IMS &therefore; Fish Summary Report per Supplier &therefore; Actual</title>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="search" method="post">
                        ...
                        <input type="hidden" name="item" value="FishSumPerSuppActual" />
                        <input type="hidden" name="type" value="xls" />
                        <input type="hidden" id="params" name="params" value="<%=cDateH %>" />
                        <table class="collapse tblForm row-select">
                            <caption>Summary Report &therefore; per Supplier &therefore; Actual</caption>
                            <tbody>
                                <tr>
