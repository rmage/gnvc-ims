...
<html>
    <head>
        ...
        <title>IMS &therefore; Transaction &therefore; per Category</title>
    ...
    <body>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="generator" method="post">
                        ...
                        <input type="hidden" name="item" value="NFTPerCat" />
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Transaction &therefore; per Category</caption>
                            <tbody>
                                <tr>
        ...
        <script>
            ...
            $('#generator').bind('submit', function() {
                $('#params').val($("#dateFrom").val() + ':' + $("#dateTo").val() + ':' + $('#category').val());
            });
        </script>
