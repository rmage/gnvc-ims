...
<html>
    <head>
        ...
        <title>IMS &therefore; Delivery Receipt &therefore; per Period</title>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="generator" method="post">
                        ...
                        <input type="hidden" name="item" value="NFDrRegisterPerPeriod" />
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Delivery Receipt &therefore; per Period</caption>
                            <tbody>
                                <tr>
