...
<html>
    <head>
        ...
        <title>IMS &therefore; Receiving Report &therefore; per Period</title>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="generator" method="post">
                        ...
                        <input type="hidden" name="item" value="NFRrRegisterPerPeriod" />
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Receiving Report &therefore; per Period</caption>
                            <tbody>
                                <tr>
