...
<html>
    <head>
        ...
        <title>IMS &therefore; Stores Withdrawal Slip &therefore; per Period</title>
    ...
    <body>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="generator" method="post">
                        ...
                        <input type="hidden" name="item" value="NFSwsRegisterPerPeriod" />
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Stores Withdrawal Slip &therefore; per Period</caption>
                            <tbody>
                                <tr>
        ...
        <script>
            ...
            $('#generator').bind('submit', function() {
                $('#params').val($("#dateFrom").val() + ':' + $("#dateTo").val() + ":" + $("#departmentCode").val());
            });
        </script>
