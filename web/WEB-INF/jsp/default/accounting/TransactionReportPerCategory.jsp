...
<html>
    <head>
        ...
        <title>IMS &therefore; Transaction Report &therefore; per Category</title>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="generator" method="post">
                        ...
                        <input type="hidden" name="item" value="ACCTransactionReportPerCategory" />
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Transaction Report &therefore; per Category</caption>
                            <tbody>
                                <tr>
