...
<html>
    <head>
        ...
        <title>IMS &therefore; Document Summary &therefore; per Category</title>
            ...
            <div id="content" class="span-24 last">
                <div class="box">
                    <form action="GenerateReport.htm" id="generator" method="post">
                        ...
                        <input type="hidden" name="item" value="ACCNFDocumentSummaryPerCategory" />
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Document Summary &therefore; per Category</caption>
                            <tbody>
                                <tr>
