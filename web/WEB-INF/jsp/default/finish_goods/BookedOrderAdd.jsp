                ...
                <div class="box">
                    ...
                    <table class="collapse tblForm">
                        ...
                        <tr>
                            ...
                            <td><input tabindex="15" id="i12" type="text" size="3" ></td>
                        </tr>
                        <tr>
                            <td>Can Size / NW</td>
                            <td>
                        ...
                        <tr>
                            <td>Quantity (FCL)</td>
                            <td><input tabindex="6" id="i3" type="text" size="1" onblur="if(!isNumber(this.value)) { this.value = 1; }" > FCL</td>
                            <td>Payment Terms</td>
                            <td><input tabindex="17" id="i14" type="text" /></td>
                        </tr>
                        <tr>
                            <td>Cases per FCL</td>
                            <td><input tabindex="7" id="i4" type="text" size="3" onblur="if(!isNumber(this.value)) { this.value = 0; }" > Cs</td>
                            <td>GSP Form</td>
                        ...
                        <tr>
                            ...
                            <td><input tabindex="19" id="i16" type="text" size="3" value="1" onblur="if(!isNumber(this.value)) { this.value = 1; }" /> CAN CODES</td>
                        </tr>
                        <tr>
                            <td>Commission</td>
                        ...
                        <tr>
                            ...
                            <td>Drained / Pressed Wt</td>
                            <td><input tabindex="39" id="j12" type="text" size="3" ></td>
                        </tr>
                        <tr>
                            <td>Can Size / NW</td>
                            <td>
                        ...
                        <tr>
                            <td>Quantity (FCL)</td>
                            <td><input tabindex="30" id="j3" type="text" size="1" onblur="if(!isNumber(this.value)) { this.value = 1; }" > FCL</td>
                            <td>Payment Terms</td>
                            <td><input tabindex="41" id="j14" type="text" /></td>
                        </tr>
                        <tr>
                            <td>Cases per FCL</td>
                            <td><input tabindex="31" id="j4" type="text" size="3" onblur="if(!isNumber(this.value)) { this.value = 0; }" > Cs</td>
                            <td>GSP Form</td>
                        ...
                        <tr>
                            ...
                            <td>Can Code Max per FCL</td>
                            <td><input tabindex="43" id="j16" type="text" size="3" value="1" onblur="if(!isNumber(this.value)) { this.value = 1; }" /> CAN CODES</td>
                        </tr>
                        <tr>
                            <td>Commission</td>
                        ...
                        <tr>
                            ...
                            <td>Drained / Pressed Wt</td>
                            <td><input tabindex="63" id="k12" type="text" size="3" ></td>
                        </tr>
                        <tr>
                            <td>Can Size / NW</td>
                            <td>
                        ...
                        <tr>
                            <td>Quantity (FCL)</td>
                            <td><input tabindex="54" id="k3" type="text" size="1" onblur="if(!isNumber(this.value)) { this.value = 1; }" > FCL</td>
                            <td>Payment Terms</td>
                            <td><input tabindex="65" id="k14" type="text" /></td>
                        </tr>
                        <tr>
                            <td>Cases per FCL</td>
                            <td><input tabindex="55" id="k4" type="text" size="3" onblur="if(!isNumber(this.value)) { this.value = 0; }" > Cs</td>
                            <td>GSP Form</td>
                        ...
                        <tr>
                            ...
                            <td>Can Code Max per FCL</td>
                            <td><input tabindex="67" id="k16" type="text" size="3" value="1" onblur="if(!isNumber(this.value)) { this.value = 1; }" /> CAN CODES</td>
                        </tr>
                        <tr>
                            <td>Commission</td>
