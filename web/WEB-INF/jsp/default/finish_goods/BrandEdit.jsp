...
<html>
    <head>
        ...
        <title>IMS &therefore; Finished Goods Brand &therefore; Update</title>
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                    <form action="FGBrand.htm" id="form" method="post">
                        ...
                        <input type="hidden" name="key" value="${ims.b.brand_id}">
                        ...
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="brandName" maxlength="100" name="brandName" size="50" value="${ims.b.brand_name}" required></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
