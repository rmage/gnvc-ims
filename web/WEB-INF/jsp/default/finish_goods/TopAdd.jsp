...
<html>
    <head>
        ...
        <title>IMS &therefore; Finished Goods Term of Payment &therefore; Create</title>
                        ...
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" id="topCode" maxlength="50" name="topCode" size="20" required ></td>
                                </tr>
                                <tr>
                                    <td>Description<span style="float: right">*</span></td>
                                    <td><input type="text" id="topDescription" maxlength="100" name="topDescription" size="50" required></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
