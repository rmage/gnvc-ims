...
<html>
    <head>
        <title>IMS &therefore; Generate &therefore; PRS Not Yet PO</title>
    ...
    <body>
                ...
                <div class="box">
                    <form action="#" method="post" id="genForm">
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Generate &therefore; PRS Not Yet PO</caption>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="userId" name="userId">
                                            ...
                                            <option value="-">-- unassigned PRS --</option>
                                        </select>
                                    </td>
                                </tr>
                            </tbody>
        ...
        <script>
            ...
            $('#genForm').bind('submit', function() {
                window.location.replace('GenerateReport.htm?action=index&item=PRCPrsNotYetPo&type=xls&params=' +
                        $('#dateFrom').val() + ':' + $('#dateTo').val() + ':' + $('#userId').val());
                return false;
            });
        </script>
    </body>
