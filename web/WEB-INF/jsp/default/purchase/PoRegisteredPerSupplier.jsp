...
<html>
    <head>
        <title>IMS &therefore; Generate &therefore; PO Registered Per Supplier</title>
    ...
    <body>
                ...
                <div class="box">
                    <form action="#" method="post" id="genForm">
                        ...
                        <table class="collapse tblForm row-select">
                            <caption>Generate &therefore; PO Registered Per Supplier</caption>
        ...
        <script>
            ...
            $('#genForm').bind('submit', function() {
                window.location.replace('GenerateReport.htm?action=index&item=PRCPoRegisteredPerSupplier&type=xls&params=' +
                        $('#asOf').val());
                return false;
            });
        </script>
