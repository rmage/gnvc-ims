                        ...
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody class="tbl-nohover">
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" class="shorttext" name="categoryCode" value="<%= dto.getCategoryCode()%>" size="30" />
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" class="shorttext" name="categoryName" value="<%= dto.getCategoryName()%>" size="30" />
                                        </label>
                                        <label class="requiredfield" title="This Field Is Required!">*</label>
                                    </td>
                                </tr>  
