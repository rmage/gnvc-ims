...
<body>
    <%
    	FishWSType dto = (FishWSType) request.getAttribute("dto");
    %>
    <div class="container">
        ...
        <div id="content" style="display: none" class="span-24 last">
            <div class="box">
                <table class="collapse tblForm row-select">
                    <caption>Fish WS Type - View</caption>
                    ...
                    <tfoot>
                    <td colspan="2">
                        <form action="FishWsType.htm" >
                            <input type="hidden" name="action" value="findByPrimaryKey" />
                            <input type="hidden" name="mode" value="edit" />
                            <input type="hidden" name="wsTypeId" value="<%= dto.getId()%>" />
