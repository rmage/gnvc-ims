...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>IMS - View City</title>
        <%@include file="../metaheader.jsp" %>
    </head>
    <body>
     <%
     	com.app.wms.engine.db.dto.City dto = (com.app.wms.engine.db.dto.City) request.getAttribute("dto");
     %>
    <div class="container">
...
--%>
                    ...
                    <tfoot>
                    <td colspan="2">
                        <form action="City.htm" >
                            <input type="hidden" name="action" value="findByPrimaryKey" />
                            <input type="hidden" name="mode" value="edit" />
                            <input type="hidden" name="cityCode" value="<%= dto.getCityCode()%>" />
