...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>IMS - New Price Catalog</title>
                        ...
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody class="tbl-nohover">
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" class="shorttext" name="catalogCode" maxlength="10" size="12" />
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" class="shorttext" name="catalogName" maxlength="25" size="30" />
                                        </label>
                                        <label class="requiredfield" title="This Field Is Required!">*</label>
                                    </td>
                                </tr>
