...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>IMS - Update Consignee</title>
                ...
                <div class="box">
                    <form action="Consignee.htm" >
						...
						<table class="collapse tblForm row-select">
                            <caption>Consignee - Edit</caption>
                            <tbody class="tbl-nohover">
                                <tr>
                                   <td class="style1"></td>
                                   <td width="39%" class="style1">Consignee Code</td>
                                   <td width="61%" class="style1">
                                        <label>
                                            <input type="text" name="consigneeCode" value="<%=dto.getConsigneeCode() %>" size="30" readonly/>
                                        </label>
                                ...
                                <tr>
                                 	<td class="style1"></td>
                                    <td width="9%" class="style1">Consignee Name</td>
                                ...
                                <tr>
                                 	<td class="style1"></td>
                                    <td width="9%" class="style1">Consignee Phone</td>
                                    <td width="11%" class="style1">
                                        <label>
