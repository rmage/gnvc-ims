...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <head>
        <title>IMS - View Cold Storage</title>
        <%@include file="../metaheader.jsp" %>
    </head>
</head>
<body>
    <%
    	FishStorage dto = (FishStorage) request.getAttribute("dto");
    %>
    <div class="container">
        ...
        <div id="content" style="display: none" class="span-24 last">
            <div class="box">
                <table class="collapse tblForm row-select">
                    <caption>Cold Storage - View</caption>
                    ...
                    <tfoot>
                    <td colspan="2">
                        <form action="FishStorage.htm" >
                            <input type="hidden" name="action" value="findByPrimaryKey" />
                            <input type="hidden" name="mode" value="edit" />
                            <input type="hidden" name="csId" value="<%= dto.getId()%>" />
