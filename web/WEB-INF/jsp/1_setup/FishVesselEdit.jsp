...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <%
            ...
            FishVessel dto = (FishVessel) m.get("dto");
        %>
            ...
            <div id="content" style="display: none" class="span-24 last">
                <div class="box">
                	<table class="collapse tblForm row-select">
	                    ...
	                    <tbody class="tbl-nohover">                          
	                        <tr>
	                           ...
	                           <td class="style1">
	                                <label><%=dto.getSupplier().getCode()%></label>
	                            </td>
	                        </tr>
	                        <tr>
	                        	<td class="style1">Supplier Name</td>
	                            <td class="style1">
	                                <label><%=dto.getSupplier().getName()%></label>
	                            </td>
	                        </tr>
	                    </tbody>
	                </table>
                    ...
                    <form action="FishVessel.htm" method="post" name="form" id="addForm">
                        ...
                        <input type="hidden" name="supplierId" value="<%=dto.getSupplier().getId()%>" />
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody class="tbl-nohover">                          
                                ...
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="name" value="<%=dto.getName()%>" size="50" class="validate[required] text-input"/>
                                        </label>
                                        <label class="requiredfield" title="This Field Is Required!">*</label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="batchNo" value="<%=dto.getBatchNo()%>" size="50" class="validate[required] text-input"/>
                                        </label>
                                        <label class="requiredfield" title="This Field Is Required!">*</label>
                                    </td>
                                </tr>
