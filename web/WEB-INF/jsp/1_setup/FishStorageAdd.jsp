                        ...
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody class="tbl-nohover">                          
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input type="text" id="code" name="code" value="" size="30" pattern="^\S+[A-Za-z0-9]+\S" required="true"/>
                                        </label>
                                        <label>*</label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input type="text" name="description" value="" size="30" pattern="^\S+[^'\x22]+\S" required="true"/>
                                        </label>
                                        <label>*</label>
                                    </td>
                                </tr>
