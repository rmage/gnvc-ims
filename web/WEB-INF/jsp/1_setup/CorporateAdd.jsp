            ...
            <div id="content" style="display: none" class="span-24 last">
                ...
                <div class="box">
                    <form action="Corporate.htm" method="post">
                        ...
                        <input type="hidden" name="corpId" value="<%= m.get("corpId")%>"/>
                        <table class="collapse tblForm row-select">
                            ...
                            <tbody class="tbl-nohover">
                                <tr>
                                    ...
                                    <td class="style1">
                                        <label>
                                            <input type="text" name="corpId" value="<%=m.get("corpId")%>" size="30" readonly/>
                                        </label>
	                            ...
	                            <tr>
                                 	<td>&nbsp;</td>
                                 	<td width="15%"class="style1">Province</td>
