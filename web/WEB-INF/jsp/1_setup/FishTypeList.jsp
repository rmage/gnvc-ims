                ...
                <div class="box">
                    <form action="FishType.htm" method="post">
                        <table class="collapse tblForm row-select">
                            <caption>Search Fish Type</caption>
                            <tbody>
                                <tr>
                                    <td width="20%">
                                        Fish Type Code
                                    ...
                                    <td>
                                        <input type="text" name="fishCode" value=""/>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <table class="collapse tblForm row-select">
                        <caption>Fish Type - Search Result</caption>
                        <thead>
                            <tr>
                                ...
                                <c:forEach items="${model.fishTypes}" var="fishType">
                                    <tr class="ganjil">
                                        ...
                                        <c:url value="FishType.htm" var="urlEdit">
                                            <c:param name="fishTypeId" value="${fishType.id}"/>
                                        ...
                                        <td class="style1"><c:out value="${fishType.code}"/></td>
                                        <td class="style1"><c:out value="${fishType.description}"/></td>
                                        <td class="center"><c:out value="${fishType.isActive}"/></td>
                                    </tr>
                                </c:forEach>
                            </c:if>
                          <tr>
                                <td colspan="5">
                                    <span class="style1">
                                        <c:if test="${model.page !=null && model.page > 1}">
                                            <a href="FishType.htm?page=<c:out value="${model.page-1}" />">
                                                &lt;
                                            </a>
                                        </c:if>
