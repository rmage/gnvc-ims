...
public class PrsDetailDaoImpl extends AbstractDAO implements ParameterizedRowMapper<PrsDetail>, PrsDetailDao
{
	...
	{
		SqlUpdate su = new SqlUpdate( dataSource, "INSERT INTO " + getTableName() + " ( prsnumber, productcode, productname, qty, uom_name ) VALUES ( ?, ?, ?, ?, ? )");
		...
		su.declareParameter( new SqlParameter( java.sql.Types.VARCHAR) );
		su.compile();
		su.update( new Object[] { dto.getPrsnumber(),dto.getProductcode(),dto.getProductname(),dto.getQty(),dto.getUomName()} );
