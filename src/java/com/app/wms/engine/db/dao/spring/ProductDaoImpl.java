...
//		dto.setId( rs.getInt( 1 ) );
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_id = :productId'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'bar_code = :barCode'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_code = :productCode'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_name = :productName'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_alias = :productAlias'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_category = :productCategory'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'brand_name = :brandName'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_type = :productType'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_color = :productColor'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'product_description = :productDescription'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'volume_weight = :volumeWeight'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_weight = :unitWeight'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'volume_matrix = :volumeMatrix'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_matrix = :unitMatrix'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_length = :unitLength'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_width = :unitWidth'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_height = :unitHeight'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_piece = :unitPiece'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_box = :unitBox'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_cartoon = :unitCartoon'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'unit_pallete = :unitPallete'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'user_id = :userId'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'corp_id = :corpId'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'wh_code = :whCode'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'is_active = :isActive'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'is_delete = :isDelete'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'created_by = :createdBy'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'created_date = :createdDate'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'updated_by = :updatedBy'.
	 */
	@Transactional
	...
	/** 
	 * Returns all rows from the product table that match the criteria 'updated_date = :updatedDate'.
	 */
	@Transactional
        ...
        try {
        	...
        	if(productCode == null || productName == null){
        		...
        		sb.append("declare @Page int, @PageSize int "
        				...
        				+"set @PageSize = 10; "
        				+"with PagedResult "
        				+"as (select ROW_NUMBER() over (order by product_code desc) as id, product_id, product_code, product_name, is_active from product" +
        						" where product_code like '%"+productCode+"%' and product_name like '%"+productName+"%' ) "
