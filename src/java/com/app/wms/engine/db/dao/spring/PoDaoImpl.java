...
public class PoDaoImpl extends AbstractDAO implements ParameterizedRowMapper<Po>, PoDao {
    ...
    public Po mapRow(ResultSet rs, int row) throws SQLException {
        ...
        CurrencyRate cr = currencyRateDao.findLatestByCurrencyCodeAndDate(dto.getCurrency(), dto.getPodate());
    ...
    public Po findByPrimaryKey(long id) throws PoDaoException {
        try {
            List<Po> list = jdbcTemplate.query("SELECT * FROM " + getTableName() + " WHERE po_code = ?", this, id);
    ...
    /**
     * Returns all rows from the po table that match the criteria 'ponumber =
     * :ponumber'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'podate =
     * :podate'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'prsnumber =
     * :prsnumber'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'prsdate =
     * :prsdate'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'deliverydate
     * = :deliverydate'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'poreferensi =
     * :poreferensi'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'createdby =
     * :createdby'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'corpid =
     * :corpid'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'wh_code =
     * :whCode'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'supplier_name
     * = :supplierName'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'currency =
     * :currency'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'prsremarks =
     * :prsremarks'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'role_code =
     * :roleCode'.
     */
    @Transactional
    ...
    /**
     * Returns all rows from the po table that match the criteria 'status =
     * :status'.
     */
    @Transactional
    ...
    /**
     * Returns the rows from the po table that matches the specified primary-key
     * value.
     */
