 ...
 * @author Rofy
 */
public class GrAjaxDocument implements Serializable{
        protected String documentNo;
        protected String irDocumentNo;
	...
	public void setDocumentNo(String documentNo){
        ...
        public String getirDocumentNo(){
		return irDocumentNo;
	}

	public void setirDocumentNo(String irDocumentNo){
		this.irDocumentNo = irDocumentNo;
	}
