...
/** 
 * This class represents the primary key of the ws table.
 */
public class WsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof WsPk)) {
			return false;
		}
		
		final WsPk _cast = (WsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.WsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
