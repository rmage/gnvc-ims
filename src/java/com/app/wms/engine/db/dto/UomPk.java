...
/** 
 * This class represents the primary key of the uom table.
 */
public class UomPk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof UomPk)) {
			return false;
		}
		
		final UomPk _cast = (UomPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.UomPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
