...
/** 
 * This class represents the primary key of the pts table.
 */
public class PtsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof PtsPk)) {
			return false;
		}
		
		final PtsPk _cast = (PtsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.PtsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
