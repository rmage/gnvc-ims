...
/** 
 * This class represents the primary key of the sws table.
 */
public class SwsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SwsPk)) {
			return false;
		}
		
		final SwsPk _cast = (SwsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.SwsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
