...
/** 
 * This class represents the primary key of the department table.
 */
public class DepartmentPk implements Serializable
{
	 ...
	 * @param id
	 */
	public DepartmentPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof DepartmentPk)) {
			return false;
		}
		
		final DepartmentPk _cast = (DepartmentPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.DepartmentPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
