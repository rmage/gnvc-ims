...
{
	/** 
	 * This attribute maps to the column id in the stock_in table.
	 */
	protected int id;

	/** 
	 * This attribute maps to the column document_no in the stock_in table.
	 */
	protected String documentNo;

	/** 
	 * This attribute maps to the column document_date in the stock_in table.
	 */
	protected Date documentDate;

	/** 
	 * This attribute maps to the column product_code in the stock_in table.
	 */
	protected String productCode;

	/** 
	 * This attribute maps to the column product_name in the stock_in table.
	 */
	protected String productName;

	/** 
	 * This attribute maps to the column quantity in the stock_in table.
	 */
	...
	/** 
	 * This attribute maps to the column is_active in the stock_in table.
	 */
	protected String isActive;

	/** 
	 * This attribute maps to the column is_delete in the stock_in table.
	 */
	protected String isDelete;

	/** 
	 * This attribute maps to the column created_by in the stock_in table.
	 */
	protected String createdBy;

	/** 
	 * This attribute maps to the column created_date in the stock_in table.
	 */
	protected Date createdDate;

	/** 
	 * This attribute maps to the column updated_by in the stock_in table.
	 */
	protected String updatedBy;

	/** 
	 * This attribute maps to the column updated_date in the stock_in table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof StockIn)) {
			return false;
		}
		
		final StockIn _cast = (StockIn) _other;
		if (id != _cast.id) {
			return false;
		}
	 ...
	 * @return StockInPk
	 */
	public StockInPk createPk()
	{
		return new StockInPk(id);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.StockIn: " );
		ret.append( "id=" + id );
