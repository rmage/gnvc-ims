...
/** 
 * This class represents the primary key of the product_category table.
 */
public class ProductCategoryPk implements Serializable
{
	 ...
	 * @param id
	 */
	public ProductCategoryPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ProductCategoryPk)) {
			return false;
		}
		
		final ProductCategoryPk _cast = (ProductCategoryPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.ProductCategoryPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
