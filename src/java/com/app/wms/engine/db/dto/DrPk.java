...
/** 
 * This class represents the primary key of the dr table.
 */
public class DrPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof DrPk)) {
			return false;
		}
		
		final DrPk _cast = (DrPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.DrPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
