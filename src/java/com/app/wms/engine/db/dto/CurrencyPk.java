...
/** 
 * This class represents the primary key of the currency table.
 */
public class CurrencyPk implements Serializable
{
	 ...
	 * @param id
	 */
	public CurrencyPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof CurrencyPk)) {
			return false;
		}
		
		final CurrencyPk _cast = (CurrencyPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.CurrencyPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
