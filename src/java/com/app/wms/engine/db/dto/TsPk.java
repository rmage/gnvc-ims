...
/** 
 * This class represents the primary key of the ts table.
 */
public class TsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TsPk)) {
			return false;
		}
		
		final TsPk _cast = (TsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.TsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
