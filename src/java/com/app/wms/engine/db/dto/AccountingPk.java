...
/** 
 * This class represents the primary key of the accounting table.
 */
public class AccountingPk implements Serializable
{
	 ...
	 * @param id
	 */
	public AccountingPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof AccountingPk)) {
			return false;
		}
		
		final AccountingPk _cast = (AccountingPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.AccountingPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
