...
/** 
 * This class represents the primary key of the wh table.
 */
public class WhPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof WhPk)) {
			return false;
		}
		
		final WhPk _cast = (WhPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.WhPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
