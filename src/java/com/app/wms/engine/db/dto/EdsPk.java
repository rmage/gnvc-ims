...
/** 
 * This class represents the primary key of the eds table.
 */
public class EdsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof EdsPk)) {
			return false;
		}
		
		final EdsPk _cast = (EdsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.EdsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
