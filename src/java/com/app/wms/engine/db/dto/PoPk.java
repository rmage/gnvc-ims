...
/** 
 * This class represents the primary key of the po table.
 */
public class PoPk implements Serializable
{
	protected long id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof PoPk)) {
			return false;
		}
		
		final PoPk _cast = (PoPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.PoPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
