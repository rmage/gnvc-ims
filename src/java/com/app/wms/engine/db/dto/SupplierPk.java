...
/** 
 * This class represents the primary key of the supplier table.
 */
public class SupplierPk implements Serializable
{
	 ...
	 * @param id
	 */
	public SupplierPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SupplierPk)) {
			return false;
		}
		
		final SupplierPk _cast = (SupplierPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.SupplierPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
