...
/** 
 * This class represents the primary key of the po_detail table.
 */
public class PoDetailPk implements Serializable
{
	 ...
	 * @param id
	 */
	public PoDetailPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof PoDetailPk)) {
			return false;
		}
		
		final PoDetailPk _cast = (PoDetailPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.PoDetailPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
