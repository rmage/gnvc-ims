...
/** 
 * This class represents the primary key of the user_role table.
 */
public class UserRolePk implements Serializable
{
	 ...
	 * @param id
	 */
	public UserRolePk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof UserRolePk)) {
			return false;
		}
		
		final UserRolePk _cast = (UserRolePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.UserRolePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
