...
/** 
 * This class represents the primary key of the warehouse table.
 */
public class WarehousePk implements Serializable
{
	 ...
	 * @param id
	 */
	public WarehousePk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof WarehousePk)) {
			return false;
		}
		
		final WarehousePk _cast = (WarehousePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.app.wms.engine.db.dto.WarehousePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
